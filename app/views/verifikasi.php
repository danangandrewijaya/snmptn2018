...
<head>
  ...
  <title>SNMPTN 2018 - Universitas Diponegoro</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-light sidenav-toggled" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">SNMPTN 2018 - Universitas Diponegoro</a>
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Prestasi</div>
        <div class="card-body">
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © SNMPTN 2018 - Universitas Diponegoro</small>
        </div>
      </div>
    </footer>
